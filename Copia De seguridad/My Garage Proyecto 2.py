...
def Taller():
    ...
    t=Label (win3, text="⚠ ADVERTENCIA: Al selecionar el Moto reproducira su sonido ⚠")
    t.place(x=305, y=10)
    t.configure(bg="Orange2",fg="Grey20",font="Unispace", width=65, height=2)

    imgBoton1=PhotoImage(file="Motor 1.gif")
    BM1=Button(win3,text="Motor1",bg="Orange4",image=imgBoton1).place(x=100, y=200)

    imgBoton2=PhotoImage(file="Motor 2.gif")
    BM2=Button(win3,text="Motor1",bg="Grey83",image=imgBoton2).place(x=500, y=200)

    imgBoton3=PhotoImage(file="Motor 3.gif")
    BM3=Button(win3,text="Motor1",bg="Gold",image=imgBoton3).place(x=900, y=200)
...
def Lexus():
    ...
    conte=Button(lfa_win,bg="Black",font=('helvica'))
